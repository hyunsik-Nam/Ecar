...
<body>
	<div id="map" style="width: 1080; height: 350px;"></div>
...
<!-- 다중마커 생성 및 열린마커 인포윈도우 닫기-->
 ...
 function displayMarker(locPosition, message) {
	...
	<div style="width: 40%; float: left;">
		<p>
			<span
				style="font-size: 50px; border-bottom: 12px solid #dcf1fb; padding: 0 0 0 0.2em;">NEWS</span>
				&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="../api/news.shop" style="text-decoration:none;">더보기</a></span>
		</p>
		<form action="news.shop" method="post" name="n">
			...
			<table>
				...
				<c:forEach items="${news}" var="n">
					<tr>
						<td colspan="4" width="800"><a href="${n.originallink}" target="_blank" style="text-decoration:none;">${n.title}"</a></td>
					</tr>


					<tr>
						<td colspan="6" height="1" width="1000" bgcolor="lightblue"></td>
					</tr>
